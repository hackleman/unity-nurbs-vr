...
namespace kmty.NURBS {
    ...
    public class SurfaceHandler : MonoBehaviour {
        ...
        public SurfaceCpsData SetSurfaceData() {
            ...
            {
                cpList.Add(new CP(new Vector3(point[0], point[1], point[2]), 1f));
            }

            SurfaceCpsData newData = new SurfaceCpsData(
                2, 
                new Vector2Int(4, 4), 
